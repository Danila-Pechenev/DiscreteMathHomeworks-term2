...
public class PrimaTests
{
    ...
    public void AlgorithmTest()
    {
        ...
        var minSpanningTree = Prima.FindMinSpanningTree(edges, 7);
    ...
    public void CountEdgesTest()
    {
        ...
        var minSpanningTree = Prima.FindMinSpanningTree(edges, 8);
    ...
    public void MatrixRepresentationAlgorithmTest()
    {
        ...
        var matrix = GraphRepresentation.EdgeListToAdjacencyMatrix(edges, 7);
        var minSpanningTree = Prima.FindMinSpanningTree(matrix);
    ...
    [Test]
    public void MatrixRepresentationCountEdgesTest()
    {
        var edges = new List<Edge>();
        edges.Add(new Edge(0, 1, 6));
        edges.Add(new Edge(1, 2, 19));
        ...
        var matrix = GraphRepresentation.EdgeListToAdjacencyMatrix(edges, 8);
        var minSpanningTree = Prima.FindMinSpanningTree(matrix);
