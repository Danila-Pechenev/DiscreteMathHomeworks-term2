...
public class DinicTests
{
    ...
    public void FindMaxFlowGraphCorrectnessTest()
    {
        ...
        var maxFlowGraph = Dinic.FindMaxFlowGraph(capacityAdjacencyList, 0, 5);
        int[] sums = new int[6];
    ...
    public void FindMaxFlowValueTest()
    {
        ...
        var capacityAdjacencyList = GraphRepresentation.EdgeListToAdjacencyList(edges, 6);
        int maxFlow = Dinic.FindMaxFlowValue(capacityAdjacencyList, 0, 5);
    ...
    public void FindMaxFlowValueInBigGraphTest()
    {
        ...
        int maxFlow = Dinic.FindMaxFlowValue(capacityAdjacencyList, 0, 13);
